...
- 마지막 Conclusion은 해낸 것과 얻은 것, 그리고 미숙했던 점과 앞으로 개선할 점을 회고하듯 담백하고 자연스럽게 정리하며 마무리합니다.
...
- 블로그를 작성하면서 사용자에게 입력받은 데이터 소스가 실제 요구사항을 달성하는데 부족하다면, 스스로 내용을 지어내지 말고 사용자에게 질문하여 보완하세요.
