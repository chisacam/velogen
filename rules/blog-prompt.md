...
- 단, 각 사건을 문제,시도,결과,학습의 단순 요약으로 끝내지 말고, 그 사건이 어떻게 해결되었는지 풀어서 설명해야 합니다.
  예를 들면 '사건 A에 어떤 문제가 발생 했을때, 우리는 우선 B를 시도했고, 그 결과 C가 발생했다/해결되었습니다. 이 과정을 통해 우리는 D를 학습하게 되었습니다.' 라는 흐름을 제공된 내용을 기반으로 가능한 길게 풀어서 설명해줘야 합니다.
...
- 마지막 Conclusion은 해낸것과 얻은것, 그리고 미숙했던 점과 앞으로 개선할 점을 정리하며 글을 자연스럽게 마무리합니다.
